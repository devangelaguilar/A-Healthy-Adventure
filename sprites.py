...
class Floor_Depression(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        pg.sprite.Sprite.__init__(self, self.groups)
        self.game = game
        self.image = pg.image.load("img/platform.png").convert_alpha()
        self.rect = self.image.get_rect()
        self.x = x
        self.y = y
...
class Floor_Depression_1(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        pg.sprite.Sprite.__init__(self, self.groups)
        self.game = game
        self.image = pg.image.load("img/platform2.png").convert_alpha()
        self.rect = self.image.get_rect()
        self.x = x
        self.y = y
        self.rect.x = x * TILESIZE
...
class Floor_Depression_2(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        pg.sprite.Sprite.__init__(self, self.groups)
        self.game = game
        self.image = pg.image.load("img/platform3.png").convert_alpha()
        self.rect = self.image.get_rect()
        self.x = x
        self.y = y
        self.rect.x = x * TILESIZE
...
class Proyectil(pg.sprite.Sprite):
    def __init__(self,posx,posy):
        pg.sprite.Sprite.__init__(self)
        self.imageProyectil = pg.image.load("img/Items/Energy_Ball.png")
...
class Minus_Life(pg.sprite.Sprite):
    def __init__(self, game, x,y):
        ...
        self.image = pg.image.load("img/Items/bad_heart.png").convert_alpha()
        self.image.set_colorkey(colors.BLACK)
        self.rect = self.image.get_rect()
        self.x = x
        self.y = y
...
class Door(pg.sprite.Sprite):
    def __init__(self, game, x,y):
        ...
        self.image = pg.image.load("img/Items/portal.png").convert_alpha()
        self.image.set_colorkey(colors.BLACK)
        self.rect = self.image.get_rect()
        self.x = x
        self.y = y
